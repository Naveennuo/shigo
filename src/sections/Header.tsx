    ...
    <>
      ...
      <header className="absolute top-0 left-0 w-full z-40">
        ...
        <div className="md:hidden flex flex-wrap justify-center items-center gap-4 bg-white/90 backdrop-blur py-2 px-3">
          <a href={TEL} className="flex items-center gap-2 text-[15px] sm:text-xs font-semibold text-[#003a64]">
            <Phone size={14} className="text-[#0092fb]" />
            +91 95255 25552
          </a>
          <a href={EMAIL} className="flex items-center gap-2 text-[15px] sm:text-xs font-semibold text-[#003a64]">
